...
describe('<SearchBar />', () => {
  ...
  it('SearchBar render test', () => {
    ...
    const component = mount(
      <SearchBar value={searchValues} onChange={()=>{}} onKeyDown={()=>{}} onToggle={()=>{}} onSearch={()=>{}} searching={false} searchScore={true}/>,
    );
  ...
  it('SearchBar-searching render test', () => {
    ...
    const component = mount(
      <SearchBar value={searchValues} onChange={()=>{}} onKeyDown={()=>{}} onToggle={()=>{}} onSearch={()=>{}} searching={true} searchScore={false}/>,
    );
