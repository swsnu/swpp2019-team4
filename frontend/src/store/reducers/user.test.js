...
describe('Reducer', () => {
  ...
  it('should call put coursepref temp and if courespref is not exists then extend changed courses', () => {
    let stubState2 = {...stubState, rated_course:[{id:0, score:3}], unrated_course:[{id:0, score:7}], changed_courses:[]}
  ...
  it('should call put coursepref temp and if courespref is exists then modify changed courses', () => {
    let stubState2 = {...stubState, rated_course:[{id:0, score:3}, {id:2, score:7}], unrated_course:[{id:0, score:7}, {id:3, score:3}], changed_courses:[{id:0, score:7}, {id:1, score:3}]}
    const newState = reducer(stubState2, {
      type: actionTypes.PUT_COURSEPREF_TEMP,
      coursepref: {id: 0, score: 5}
    });
  ...
  it('should call get rated courses', () => {
    let stubState2 = {...stubState, rated_course:[{id:0, score:5}]}
    const newState = reducer(stubState2, {
  ...
  it('should call get unrated courses', () => {
    let stubState2 = {...stubState, unrated_course:[{id:0, score:5}]}
    const newState = reducer(stubState2, {
  ...
  it('should call post course temp', () => {
    let stubState2 = {...stubState, timetable:{id:0, course:[{id:0, name: "과기글"}, {id:1, name: "전전회"}]}}
    const newState = reducer(stubState2, {
      type: actionTypes.POST_COURSE_TEMP,
      course: {id:2, name: "소개원실"}
    });
    expect(newState.timetable.course).toStrictEqual([{id:0, name: "과기글"}, {id:1, name: "전전회"}, {id:2, name: "소개원실"}])
  });
      
  it('should call delete course temp', () => {
    let stubState2 = {...stubState, timetable:{id:0, course:[{id:0, name: "과기글"}, {id:1, name: "전전회"}, {id:2, name: "소개원실", temp:true}]}}
    const newState = reducer(stubState2, {
