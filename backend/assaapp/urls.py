...
urlpatterns = [
    ...
    re_path(r'^verify/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>[0-9A-Za-z]{1,13}-[0-9A-Za-z]{1,20})/$', views.api_verify),
    ...
    path('timetable/<int:timetable_id>/course/', views.api_timetable_id_course, name='timetable_id_course'),
