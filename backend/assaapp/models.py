...
class Course(models.Model):
    ...
    college = models.CharField(max_length=32, default="")
    department = models.CharField(max_length=128, default="")
    degree_program = models.CharField(max_length=32, default="")
    academic_year = models.IntegerField(default=0)
    course_number = models.CharField(max_length=16, default="")
    ...
    lecture_type = models.CharField(max_length=64, default="")
    location = models.CharField(max_length=128, default="")
    professor = models.CharField(max_length=64, default="")
